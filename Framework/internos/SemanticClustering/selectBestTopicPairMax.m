function [selectedRows, selectedColumns, maxProbabilities] = selectBestTopicPairMax(numTopics, matrix, topicIndexes, clusterAssignment, mapTopics, originalNumTopics, alpha, minProbability, maxCohesion, transitionMatrix)
	...
	numTopics	
	  ...
	  for j=(i+1):numTopics,
		...
		maxObservedCohesion = max(resultingVector)/(numFactors-1);
		maxCohesion = 1.0/numFactors;
		deltaCohesion = (maxObservedCohesion - maxCohesion)/maxCohesion;

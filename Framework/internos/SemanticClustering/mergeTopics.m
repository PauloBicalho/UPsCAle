function mergeTopics(dampFactor, alpha, MODE, inputFile, outputDir)
...
mapTopics = zeros(numTopics,1);
clusterAssignments = eye(numTopics);
...
while (numTopics > 1)
      ...
      switch MODE
         case 1
            [selectedRows, selectedColumns, maxProbabilities] = selectBestTopicPairMin(numTopics, randomWalkMatrix, topicIndexes, clusterAssignments, mapTopics, originalNumTopics, alpha, minProbability, maxCohesion, transitionMatrix);
         case 2
            [selectedRows, selectedColumns, maxProbabilities] = selectBestTopicPairMean(numTopics, randomWalkMatrix, topicIndexes, clusterAssignments, mapTopics, originalNumTopics, alpha, minProbability, maxCohesion, transitionMatrix);
         case 3
            [selectedRows, selectedColumns, maxProbabilities] = selectBestTopicPairMax(numTopics, randomWalkMatrix, topicIndexes, clusterAssignments, mapTopics, originalNumTopics, alpha, minProbability, maxCohesion, transitionMatrix);
      end;

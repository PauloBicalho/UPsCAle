function [selectedRows, selectedColumns, maxProbabilities] = selectBestTopicPairMin(numTopics, matrix, topicIndexes, clusterAssignment, mapTopics, originalNumTopics, alpha, minProbability, maxCohesion, transitionMatrix)
	...
	numTopics	
	  ...
	  for j=(i+1):numTopics,
		...
		minObservedCohesion = min(resultingVector)/(numFactors-1);
		maxCohesion = 1.0/numFactors;
		deltaCohesion = (minObservedCohesion - maxCohesion)/maxCohesion;
